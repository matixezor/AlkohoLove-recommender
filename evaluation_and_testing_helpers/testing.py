...
from evaluation_and_testing_helpers.evaluation_measures import rmse
from evaluation_and_testing_helpers.evaluation_measures import mape
from evaluation_and_testing_helpers.evaluation_measures import tre
from evaluation_and_testing_helpers.evaluation_measures import hr
from evaluation_and_testing_helpers.evaluation_measures import ndcg
...
def evaluate_train_test_split_explicit(recommender, interactions_df, items_df, seed=6789):
    ...
    recommender.fit(interactions_df_train, items_df)
